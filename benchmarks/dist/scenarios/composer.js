...
exports.runComposerScenario = runComposerScenario;
...
async function runComposerScenario(options = {}) {
    ...
    for (let run = 0; run < runs; run++) {
        ...
        const benchmarkDir = path_1.default.join(resultsDir, 'temp', `compose-${run}`);
