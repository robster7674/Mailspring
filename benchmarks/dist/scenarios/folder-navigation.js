...
exports.runFolderNavigationScenario = runFolderNavigationScenario;
...
async function runFolderNavigationScenario(options = {}) {
    ...
    for (let run = 0; run < runs; run++) {
        ...
        const benchmarkDir = path_1.default.join(resultsDir, 'temp', `nav-${run}`);
